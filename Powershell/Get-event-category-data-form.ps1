...
function Get-Events() {
    ...
    $SqlCmd.CommandText = "BM_Event_ALL_Tournament_Form"
...
function Create-fann-file($liga) {
    ...
    foreach ($i in $liga) {
        $output += $i.ID +" "+ $i.ID_Season +" "+ $i.ID_HomeTeam +" "+ $i.ID_AwayTeam
        $output += " " + $i.HomeLastForm + " " + $i.HomeLastGiven + " " + $i.HomeLastTaken
        $output += " " + $i.HomeLastOnlyForm + " " + $i.HomeLastOnlyGiven + " " + $i.HomeLastOnlyTaken
        $output += " " + $i.AwayLastForm + " " + $i.AwayLastGiven + " " + $i.AwayLastTaken
        $output += " " + $i.AwayLastOnlyForm + " " + $i.AwayLastOnlyGiven + " " + $i.AwayLastOnlyTaken
        $output += [Environment]::NewLine
