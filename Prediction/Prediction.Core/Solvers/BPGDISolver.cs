...
namespace Prediction.Core.Solvers
{
    ...
    /// </summary>
    public class BPGDISolver : BaseSolver
    {
        public BPGDISolver(IDixonManager dixonManager)
            :base(dixonManager)
        {
        }
        ...
        public override double Solve(DateTime actualDate)
        {
            ...
            model.AddDecisions(attack, defence, gamma, g, mi, lambda, theta, p);
            ...
            Goal sum = model.AddGoal("sum", GoalKind.Maximize,
                Model.Sum(
                   ...
                   {
                       // home-attack
                       var lambdaHome = mi * attack[h] * defence[a] * g[h] * gamma;
